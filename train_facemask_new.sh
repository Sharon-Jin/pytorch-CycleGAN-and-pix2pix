...
python train.py --dataroot datasets/2russ2qi --display_id 1 --name 2russ2qi_dlibmask --model cycle_gan --checkpoints_dir checkpoints/ --save_epoch_freq 10 --face_mask --face_weight 3.0
