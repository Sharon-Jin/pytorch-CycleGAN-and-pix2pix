...
python train.py --dataroot datasets/3russ2jin --display_id 1 --name 3russ2jin_dlibmask --model cycle_gan --checkpoints_dir checkpoints/ --save_epoch_freq 20 --continue_train --which_epoch 200 --face_mask
