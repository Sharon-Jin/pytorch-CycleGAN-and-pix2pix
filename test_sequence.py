...
# configurations
test_video_path = 'datasets/videos/test3.MOV'
...
def main():
    ...
    run_pytorch_command = ('python test.py --which_epoch %d --dataroot %s --name %s --model cycle_gan --phase test --serial_batches' % (epoch, extract_folder, experiment_name))
